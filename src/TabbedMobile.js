    ...
    return (
      <div style={{}}>
        <Tabs
          ...
          tabTemplateStyle={{ fontSize:'4px' }}
        >
          <Tab label="Food Groups" value={0} buttonStyle={{ fontSize:'10px' }} />
          <Tab label="Healthy Plate Model" value={1} buttonStyle={{ fontSize:'10px' }} />
          <Tab label="One Serving" value={2} buttonStyle={{ fontSize:'10px' }} />
        </Tabs>
        <SwipeableViews
